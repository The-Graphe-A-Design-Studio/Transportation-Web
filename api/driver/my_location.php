<?php
    ...
    if(isset($_POST['truck_id']) && isset($_POST['del_trk_id']) && isset($_POST['lat']) && isset($_POST['lng']))
    {
        ...
        {
            $location = "update trucks set trk_lat = '".$_POST['lat']."', trk_lng = '".$_POST['lng']."' where trk_id = '".$_POST['truck_id']."'";
        ...
        {
            $active = "update delivery_trucks set lat = '".$_POST['lat']."', lng = '".$_POST['lng']."' where del_trk_id = '".$_POST['del_trk_id']."' and trk_id = '".$_POST['truck_id']."'";
            $set = mysqli_query($link, $active);

            if($set)
            {
                mysqli_query($link, "update trucks set trk_lat = '".$_POST['lat']."', trk_lng = '".$_POST['lng']."' where trk_id = '".$_POST['truck_id']."'");
